...
export interface ApiBloodBankBloodBank extends Schema.CollectionType {
...
export interface ApiBloodInventoryBloodInventory extends Schema.CollectionType {
...
export interface ApiCityCity extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    blood_banks: Attribute.Relation<
      'api::city.city',
      'oneToMany',
      'api::blood-bank.blood-bank'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::blood-bank.blood-bank': ApiBloodBankBloodBank;
      'api::blood-inventory.blood-inventory': ApiBloodInventoryBloodInventory;
